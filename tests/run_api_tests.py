...
MIN_PARAMS: dict[str, dict] = {
    ...
    "delete_group_file": {"group_id": 1, "file_id": "1", "busid": 102},
    ...
    "get_group_file_url": {"group_id": 1, "file_id": "1", "busid": 102},
    ...
    "get_private_file_url": {"file_id": "1", "file_hash": "1"},
    "send_online_file": {"user_id": 1, "file_path": "", "file_name": "t"},
    "send_online_folder": {"user_id": 1, "folder_path": "", "folder_name": "t"},
    "get_online_file_msg": {"user_id": 1},
    "receive_online_file": {"user_id": 1, "msg_id": "1", "element_id": "1"},
    "refuse_online_file": {"user_id": 1, "msg_id": "1", "element_id": "1"},
    "cancel_online_file": {"user_id": 1, "msg_id": "1"},
    ...
    "get_rkey": {},
    "get_rkey_server": {},
    "download_file_stream": {"file_id": "1"},
    "download_file_record_stream": {"file_id": "1"},
    "download_file_image_stream": {"file_id": "1"},
    "upload_file_stream": {"stream_id": "api-probe", "reset": True},
